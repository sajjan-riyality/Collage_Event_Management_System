        ...
        <div class="sidenav-menu">
            ...
            <div data-simplebar>
                ...
                <li class="side-nav-item">
                    <a href="createEvent" class="side-nav-link">
                ...
                <li class="side-nav-item">
                    <a href="registrations" class="side-nav-link">
                ...
                <li class="side-nav-item">
                  ...
                  <li class="side-nav-item">
                    <a href="userDashbord" class="side-nav-link">
                        <span class="menu-icon"><i class="ti ti-file-text"></i></span>
                        <span class="menu-text"> Student Pannal</span>
                    </a>
                </li>
