                ...
                <div class="card overflow-hidden text-center h-100 p-xxl-4 p-3 mb-0">
                    ...
                    <form action="login" method="post" class="text-start mb-3">
                        <div class="mb-3">
                            ...
                            <input type="email" id="example-email" name="exampleEmail" class="form-control" placeholder="Enter your email">
                        </div>

                        <div class="mb-3">
                            <label class="form-label" for="example-password">Password</label>
                            <input type="password" id="example-password" name="examplePassword" class="form-control" placeholder="Enter your password">
                        </div>
                    ...
                    <p class="text-danger fs-14 mb-4">Don't have an account? <a href="registerPage" class="fw-semibold text-dark ms-1">Sign Up !</a></p>
